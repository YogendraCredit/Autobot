...
@CucumberOptions
        (
                features = "src/test/java/features/MVLWorkflow.feature",    //path of feature file , If multiple feature file : {"",""}
...
public class FldgRun extends AbstractTestNGCucumberTests{
